function [train_sample1, train_sample2, label1, label2] = gen_train_sample_xqda(ID_cam_train, train_feat)

label = ID_cam_train(:, 1);
cam = ID_cam_train(:, 2);   % camera label of all training data
